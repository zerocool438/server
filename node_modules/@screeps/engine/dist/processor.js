...
function processRoom(roomId, _ref) {
    var intents = _ref.intents,
        objects = _ref.objects,
        users = _ref.users,
        terrain = _ref.terrain,
        gameTime = _ref.gameTime,
    ...
    return q.when().then(function () {
        ...
        if (intents) {
            ...
            _.forEach(intents.users, function (userIntents, userId) {
                ...
                for (var objectId in userIntents.objects) {
                    ...
                    if (object.type == 'creep') require('./processor/intents/creeps/intents')(object, objectIntents, objects, terrain, bulk, userBulk, roomController, stats, gameTime, roomInfo, users);
        ...
        _.forEach(objects, function (object) {
            ...
            if (object.type == 'controller') require('./processor/intents/controllers/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime, roomInfo, users);
            ...
            if (object.type == 'tombstone') require('./processor/intents/tombstones/tick')(object, objects, terrain, bulk, userBulk, roomController, gameTime);
