...
(function () {
    ...
    function addObjectToRegister(register, type, objectInstance, objectRaw) {
        ...
        var index = objectRaw.x * 50 + objectRaw.y;
        var spatial = register.byRoom[objectRaw.room].spatial[type];
    ...
    function makeGameObject(_ref) {
        var runtimeData = _ref.runtimeData,
            intents = _ref.intents,
            memory = _ref.memory,
            getUsedCpu = _ref.getUsedCpu,
            globals = _ref.globals,
            sandboxedFunctionWrapper = _ref.sandboxedFunctionWrapper,
            getHeapStatistics = _ref.getHeapStatistics;
        ...
        runtimeData.flags.forEach(function (flagRoomData) {
            ...
            data.forEach(function (flagData) {
                ...
                if (register.byRoom[flagRoomData.room]) {
                    ...
                    var index = +info[3] * 50 + +info[4];
                    var spatial = register.byRoom[flagRoomData.room].spatial.flags;
                    if (spatial[index] === undefined) {
                        spatial[index] = [flag];
                    } else {
