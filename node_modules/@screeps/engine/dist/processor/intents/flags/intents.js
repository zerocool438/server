...
module.exports = function (object, objectIntents, roomObjects, roomTerrain, bulk, bulkUsers, roomController, stats) {
    ...
    if (objectIntents.setColor) {
        if (_.contains(['white', 'grey', 'red', 'purple', 'blue', 'cyan', 'green', 'yellow', 'orange', 'brown'], objectIntents.setColor.color) && _.contains(['white', 'grey', 'red', 'purple', 'blue', 'cyan', 'green', 'yellow', 'orange', 'brown'], objectIntents.setColor.secondaryColor)) {
...
//# sourceMappingURL=../../../sourcemaps/processor/intents/flags/intents.js.map
